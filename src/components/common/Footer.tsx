  ...
  return (
    <footer className="bg-medical-navy border-t border-white/5 pt-24 pb-12 relative overflow-hidden">
      ...
      <div className="section-container relative z-10">
          ...
          <div className="flex flex-col gap-8">
            <Link to="/" className="flex items-center gap-4 group">
              <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center shadow-luxury group-hover:scale-110 transition-transform duration-500 overflow-hidden p-1 border border-white/10">
                <img src={logo} alt="Bhargava Medical and Trauma Centre Logo" className="w-full h-full object-contain" />
              </div>
              <span className="font-serif font-bold text-3xl tracking-tight text-white">Bhargava Medical<br />&amp; Trauma Centre</span>
            </Link>
            ...
            <div className="flex gap-4">
              {[
                ...
                <motion.a
                  ...
                  className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center text-white hover:bg-medical-royal hover:text-white transition-colors shadow-glass border border-white/10"
                >
                  <Icon size={20} />
                </motion.a>
              ))}
            ...
            <ul className="flex flex-col gap-6">
              {[
                ...
                <li key={item.name}>
                  <Link
                    to={item.path}
                    className="text-white/60 text-[15px] hover:text-white transition-colors flex items-center gap-3 group font-medium"
                  >
          ...
          <div>
            ...
            <ul className="flex flex-col gap-6">
              {['Gynaecology', 'Orthopedics', 'General Medicine'].map((item) => (
                <li key={item}>
                  <Link to="/services" className="text-white/60 text-[15px] hover:text-white transition-colors flex items-center gap-3 group font-medium">
                    <div className="w-2 h-2 rounded-full bg-medical-royal/30 group-hover:bg-medical-royal group-hover:scale-125 transition-all" />
                    {item}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-8">
              <li className="flex items-start gap-5 group">
                ...
                >
                  <div className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center text-white shrink-0 group-hover:bg-medical-royal group-hover:text-white transition-colors shadow-glass border border-white/10">
                    <MapPin size={22} />
                  </div>
                  <span className="text-white/70 text-sm leading-relaxed font-medium group-hover:text-white transition-colors">30E, O Block, Kidwai Nagar, Kanpur, Uttar Pradesh 208023</span>
                </a>
              </li>
              <li className="flex items-center gap-5 group">
                ...
                <div className="flex flex-col gap-1">
                  <a href="tel:+917309038872" className="text-white/70 text-sm font-medium hover:text-white transition-colors">+91-7309038872 (Main)</a>
                  <a href="tel:+917309038868" className="text-white/70 text-sm font-medium hover:text-white transition-colors">+91-7309038868 (Alt)</a>
                </div>
              </li>
              <li className="flex items-center gap-5 group">
                <a href="mailto:bmtckanpur@gmail.com" className="flex items-center gap-5 group">
                  ...
                  <span className="text-white/70 text-sm font-medium group-hover:text-white transition-colors">bmtckanpur@gmail.com</span>
                </a>
              </li>
            </ul>
          </div>
        ...
        {/* Google Map Embed */}
        <div className="mb-16 rounded-2xl overflow-hidden border border-white/10 shadow-lg">
          <iframe
            ...
            title="Bhargava Medical and Trauma Centre Location"
          />
        </div>
