  ...
  return (
    <>
      <nav className={cn(
        ...
        isScrolled 
          ? "bg-medical-navy/95 backdrop-blur-xl border-b border-white/5 py-1.5 shadow-2xl" 
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -20 }}
            className="fixed inset-0 bg-medical-navy z-[60] lg:hidden flex flex-col p-8 overflow-y-auto"
          >
